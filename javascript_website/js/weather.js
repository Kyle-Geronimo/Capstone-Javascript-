        ...
        try {
            ...
            card.innerHTML = `
                ...
                <div class="weather-details">
                    <p><strong>Temperature:</strong> <strong>${weatherData.temperature}°C</strong></p>
                    <p><strong>Humidity:</strong> <strong>${weatherData.humidity}%</strong></p>
                    <p><strong>Precipitation:</strong> <strong>${weatherData.precipitation}mm</strong></p>
                    <p><strong>Rain Chance:</strong> <strong>${weatherData.rainChance}%</strong></p>
                </div>
            `;
